# Changelog — pre-v1 (0.x) history

Archived from the main `CHANGELOG.md` at the v1 freeze.
The main file keeps only entries since the last released version;
every `[v0.x.y]` section that was already published lives here for
